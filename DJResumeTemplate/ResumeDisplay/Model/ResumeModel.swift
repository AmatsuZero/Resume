...
class ResumeModel {
    ...
    var template: DJResumeTemplate? = try! DJResumeTemplate(rootPath: Bundle.main.privateFrameworksPath,
                                                            basePath: "https://eyrefree.github.io/EFResume")

    class func fillContent() -> ResumeContent {
    ...
    func genertate() -> String? {
        template?.content = ResumeModel.fillContent()
        return try! template?.generate()
    }
}
